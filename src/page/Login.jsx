    ...
    return (
        <div className=" w-[400px] p-5 border-[1px]  rounded-md shadow-[rgba(100,100,111,0.2)0px_7px_29px_0px]">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm ">
                ...
                <h2 className="mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Đăng nhập</h2>
            </div>
            ...
            <div className="mt-2 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p className="mt-2 text-center text-sm text-gray-500">
                    Chưa có tài khoản?
                    <Link to="/register" className="ml-2 font-semibold leading-6 text-indigo-600 hover:text-indigo-500" >Đăng ký</Link>
                </p>
            </div>
        </div>
    );
